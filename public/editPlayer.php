...
if(empty($_POST) === false)
{
    ...
    if(empty($erreur))
    {
        $player = new Player($_GET['id'], $_POST["firstName"], $_POST["lastName"], $_POST["birthday"], $_POST["picture"]);
        $player->setId($_GET['id']);
        ...
        $updatePlayer = PlayerController::update($player);
    }
}
...
<body>
    ...
    <form action="#" method="post">
        ...
        <input class="submit_form" type="submit" value="Modifier le Joueur">
