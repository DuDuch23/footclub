...
if(empty($_POST) === false)
{
    ...
    if(empty($erreur))
    {
        ...
        $match = new MatchClass(null, $_POST["score"], $_POST["scoreOpponent"], $_POST['date'], $_POST['team'], $_POST['city'],
        $_POST['teamOpponent']);
        ...
        $ajoutMatch = MatchController::add($match);
    }
}
...
<div class="content_body">
        ...
        <div class="content_form">
            <h1 class="title_form">Ajouter un Match : </h1>
